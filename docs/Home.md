...
[![Examples](https://img.shields.io/badge/examples-18-orange)](Examples)
...
| Page | Covers |
|------|--------|
| [Overview](Overview)                 | One-page tour: what VCK is / gives / never takes, modern Vulkan (v0.5), why it's fresh, summary |
...
| [Examples](Examples)                 | Walk-through of the 18 runnable examples in `example/` |
...
| [Design](Design)                     | 25 design rules, status, caveats, architecture |
